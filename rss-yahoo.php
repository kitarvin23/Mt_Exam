...
<?php
 ...
 $domOBJ->load("http://feeds.reuters.com/Reuters/worldNews");//XML page URL
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <span><a href="<?php echo $link ?>" target="http://feeds.reuters.com/Reuters/worldNews">Read more...</a></span>
                    </div>
                </div>
            </div>
        </div>
